...
class OpenHash {
	...
	static class Bucket {
		...
		public boolean equals(Object obj) {
			...
			SimpleObject2 other = (SimpleObject2) obj;
			return this.data.sno.equals(other.sno) && this.data.sname.equals(other.sname);
		}
...
//		return key.hashCode() % size;
	...
	public void dump() {
		...
		for (int i = 0; i < size; i++) {
			...
			switch (table[i].stat) {
			case OCCUPIED:
				System.out.printf("%s (%s)\n", table[i].getValue().sno, table[i].getValue().sname);
				break;
